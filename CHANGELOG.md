...
## [1.0.1] - 2026-06-07
### Fixed
- Fixed Vite esbuild runtime syntax error by using type-only import (`import type { TraceEvent }`) in the visualizer dashboard.
...
[1.0.1]: https://github.com/dhia/agent-trace/compare/v1.0.0...v1.0.1
